...
pub async fn get_item_by_id(
    pool: &sqlx::PgPool,
    id: i32,
) -> Result<Option<models::Item>, sqlx::Error> {
    sqlx::query_as::<_, models::Item>(
        "SELECT id, name, quantity, created_at FROM items WHERE id = $1",
    )
    .bind(id)
    .fetch_optional(pool)
    .await
...
pub async fn create_item_payload(
    pool: &sqlx::PgPool,
    payload: &models::CreateItemPayload,
) -> Result<models::Item, sqlx::Error> {
    sqlx::query_as::<_, models::Item>(
